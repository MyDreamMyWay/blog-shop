...
<head>
    ...
    <title>网吧云平台</title>
	<link rel="shortcut icon" href="/blog-shop/Public/favicon.ico">
    <!-- CSS文件 -->
    <link href="/blog-shop/Public/css/bootstrap.min.css" rel="stylesheet">
    <link href="/blog-shop/Public/css/font-awesome.css" rel="stylesheet">
    <link href="/blog-shop/Public/css/animate.css" rel="stylesheet">
    <link href="/blog-shop/Public/css/style.css" rel="stylesheet">
...
<body class="fixed-sidebar full-height-layout gray-bg">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <!-- <span><img alt="image" class="img-circle" src="/blog-shop/Public/img/profile_small.jpg" /></span> -->
    ...
    <!-- 全局js -->
    <script src="/blog-shop/Public/js/jquery.min.js?v=2.1.4"></script>
    <script src="/blog-shop/Public/js/bootstrap.min.js?v=3.3.6"></script>
    <script src="/blog-shop/Public/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="/blog-shop/Public/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="/blog-shop/Public/js/plugins/layer/layer.min.js"></script>
 
    <!-- 自定义js -->
    <script src="/blog-shop/Public/js/hplus.js?v=4.1.0"></script>
    <script type="text/javascript" src="/blog-shop/Public/js/contabs.js"></script>
 
    <!-- 第三方插件 -->
    <script src="/blog-shop/Public/js/plugins/pace/pace.min.js"></script>
